...
infoln "Joining india peer to the channel..."
joinChannel 1
infoln "Joining australia peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for india..."
setAnchorPeer 1
infoln "Setting anchor peer for australia..."
setAnchorPeer 2
