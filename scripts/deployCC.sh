...
## Install chaincode on peer0.india and peer0.australia
infoln "Installing chaincode on peer0.india..."
installChaincode 1
infoln "Install chaincode on peer0.australia..."
installChaincode 2

## query whether the chaincode is installed
queryInstalled 1

## approve the definition for india
approveForMyOrg 1

## check whether the chaincode definition is ready to be committed
## expect india to have approved and australia not to
checkCommitReadiness 1 "\"IndiaMSP\": true" "\"AustraliaMSP\": false"
checkCommitReadiness 2 "\"IndiaMSP\": true" "\"AustraliaMSP\": false"

## now approve also for australia
approveForMyOrg 2

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness 1 "\"IndiaMSP\": true" "\"AustraliaMSP\": true"
checkCommitReadiness 2 "\"IndiaMSP\": true" "\"AustraliaMSP\": true"
